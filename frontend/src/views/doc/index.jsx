...
const Doc = () => {
  const cardContent = `
    ...
    关于MyServerless的介绍请参见 <a href="https://gitee.com/drinkjava2/myserverless" target="_blank">MyServerless项目</a>，它是由我写的一个开源Serverless服务，主要特点是将SQL和Java直接写在前端，而不需要放在云服务器上。<br/><br/>
